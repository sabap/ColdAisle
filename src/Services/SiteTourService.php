    ...
    public static function catalog(): array
    {
        $steps = [
            ...
            [
                'id' => 'nav-ipam',
                'title' => 'IPAM',
                'body' => 'Three tools: an address plan (named hosts in a prefix), a subnet plan (a container you carve into smaller prefixes), and aligned groups (same host index across two or more prefixes). Import Excel or CSV. DHCP is a fence, not a server. Not DNS or Infoblox.',
                'page' => 'pages/ipam.php',
            ...
            [
                'id' => 'ipam-aligned',
                'title' => 'Aligned groups',
                'body' => 'Open Aligned when Metro-E (or LAN + iDRAC) should share a memorable number. Index is the offset from each prefix’s network — on a /24 that is the last octet. Assign a site to index 10 and every member prefix gets .10 in one step. Create the prefixes first; this is not a parent/child tree. Full walkthrough: Documentation → IPAM.',
                'page' => 'pages/ipam.php',
                'target' => '[data-tour="ipam-aligned"]',
                'nav' => 'ipam',
                'place' => 'bottom',
            ],
            [
